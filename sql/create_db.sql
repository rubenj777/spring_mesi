...
CREATE TABLE `app_user` (
                            ...
                            `fileName` varchar(500) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                            PRIMARY KEY (`idUser`)
...
CREATE TABLE `message` (
                           ...
                           `object` varchar(500) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product` (
                           ...
                           `fileName` varchar(45) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
                           `idUser` int NOT NULL,
...
CREATE TABLE `user_roles` (
                              ...
                              KEY `idRole` (`idRole`),
                              CONSTRAINT `user_roles_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `app_user` (`idUser`) ON DELETE CASCADE ON UPDATE CASCADE,
                              CONSTRAINT `user_roles_ibfk_2` FOREIGN KEY (`idRole`) REFERENCES `role` (`idRole`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-08-29 16:32:53
